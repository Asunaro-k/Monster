...
def download_and_save_models(save_dir="./models"):
    ...
    stdmodel_id = "stabilityai/stable-diffusion-2"
...
# 保存したモデルの読み込み
stdmodel, stt_model = load_saved_models(StableDef_model_path, stt_model_path)
        ...
        with st.form("create_monster"):
            ...
            if submit and monster_name:
                ...
                with st.spinner("モンスターを生成中..."):
                    ...
                    image = generate_monster_image(prompt)
                    if image:
                ...
                if st.button("餌をあげる"):
                    ...
                    if st.session_state.monster.exp == 0:  # レベルアップした場合
                        ...
                        with st.spinner("モンスターが進化中..."):
                            ...
                            new_image = generate_monster_image(prompt)
                            if new_image:
